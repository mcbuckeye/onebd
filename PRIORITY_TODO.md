...
- [x] Deploy structured deal- and asset-grain REST/MCP search with composable
      company, asset, target, disease, deal, date, value, evidence-attribution,
      sorting, and opaque cursor filters. Production SHA `e8678e6` passed the
      protected merge gate, Dokploy rollout, automated production verification,
