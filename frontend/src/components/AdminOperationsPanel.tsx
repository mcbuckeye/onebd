...
export default function AdminOperationsPanel() {
  ...
  useEffect(() => {
    load(tab);
  // Filter text is deliberately applied only by the Apply button; pagination
  // and time-window changes reload immediately.
  ...
  // The explicit dependencies make the interval use the latest filter state.
  // eslint-disable-next-line react-hooks/exhaustive-deps
